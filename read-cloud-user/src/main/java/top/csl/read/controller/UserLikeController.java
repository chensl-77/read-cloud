...
public class UserLikeController {
    ...
    public Result likeSeeClick(@RequestHeader("userId") Integer userId, @RequestBody RequestParams params) {
        ...
        return this.userLikeService.likeSeeClick(userId, bookId, value);
    }
    ...
    public Result<Integer> getBookLikesCount(String bookId) {
        return this.userLikeService.getBookLikesCount(bookId);
    }
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(paramType = "query", name = "size", value = "每页数量", required = true, dataType = "int")
    })
    @GetMapping("/get-books")
    public Result getUserLikeBookList(@RequestHeader("userId") Integer userId, Integer page, Integer size) {
        return this.userLikeService.getUserLikeBookList(userId, page, size);
    }
    ...
    public Result<Integer> userLikeThisBook(@RequestHeader("userId") Integer userId, String bookId) {
        return this.userLikeService.userLikeThisBook(userId, bookId);
    }
}
